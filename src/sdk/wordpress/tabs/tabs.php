...
{
	use \plainview\sdk_eightb_sold_alerts\traits\method_chaining;
	use \plainview\sdk_eightb_sold_alerts\html\element;

	/**
		@brief		\\plainview\\sdk_eightb_sold_alerts\\wordpress\\base object that created these tabs.
		@since		20130503
		@var		$base
	**/
	public $base;
	...
	**/
	...
	/**
		@brief		Collection of \\plainview\\sdk_eightb_sold_alerts\\wordpress\\tabs\\tab objects.
		@since		20130503
		@var		$tabs
	**/
	public $tabs;
	...
	**/
	...
	{
		$this->base = $base;
		$this->tabs = new \plainview\sdk_eightb_sold_alerts\collections\Collection();
		$this->_construct();
	}
