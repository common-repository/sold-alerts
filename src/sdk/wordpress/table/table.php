...
namespace plainview\sdk_eightb_sold_alerts\wordpress\table;
...
**/
class table
	extends \plainview\sdk_eightb_sold_alerts\table\table
{
	use \plainview\sdk_eightb_sold_alerts\traits\method_chaining;

	/**
		@brief		The \\plainview\\sdk_eightb_sold_alerts\\table\\wordpress\\base object that created this class.
	**/
	public $base;
