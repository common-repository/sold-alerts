...
namespace plainview\sdk_eightb_sold_alerts\form2\inputs\traits;
...
trait validation
{
	...
	**/
	...
	/**
		...
		@param		\\plainview\\sdk_eightb_sold_alerts\\form2\\validation\\error		$error		Error to append.
	...
	**/
	...
	/**
		...
		@return		array		An array of \\plainview\\sdk_eightb_sold_alerts\\form2\\validation\\error objects.
		@since		20130524
	**/
	...
	**/
	...
	/**
		...
		@return		\\plainview\\sdk_eightb_sold_alerts\\form2\\validation\\error		A new validation error.
		@since		20130524
	**/
	public function validation_error()
	{
		$error = new \plainview\sdk_eightb_sold_alerts\form2\validation\error( $this );
