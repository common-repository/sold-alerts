...
namespace plainview\sdk_eightb_sold_alerts\form2\inputs;
...
class input
{
	use \plainview\sdk_eightb_sold_alerts\html\element;
	use \plainview\sdk_eightb_sold_alerts\html\indentation;
	...
	**/
	...
	{
		$random = \plainview\sdk_eightb_sold_alerts\base::uuid();
	...
	**/
	public function display_input()
	{
		...
		if ( $input->form()->post_is_set() )
		{
			...
			if ( $value != '' )
			{
				$value = \plainview\sdk_eightb_sold_alerts\form2\form::unfilter_text( $value );
				$input->value( $value );
			}
			else
	...
	**/
	...
	{
		$r = new \plainview\sdk_eightb_sold_alerts\html\div();
	...
	**/
	public function make_id()
	{
		if ( $this->has_attribute( 'id' ) )
			return $this->get_attribute( 'id' );
		$id = $this->make_name();
		$id = \plainview\sdk_eightb_sold_alerts\base::strtolower( $id );
	...
	**/
	...
	{
		$title = \plainview\sdk_eightb_sold_alerts\form2\form::filter_text( $title );
